...
{/* Hero Section */}
<section className="flex flex-col md:flex-row items-stretch min-h-screen px-4 py-4 gap-0">
  <div className="w-full md:w-1/3 relative">
    ...
    <div className="w-full md:w-2/3 h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth ml-20 mr-20 scrollbar-hide" >
    <div className=" flex  mt-30 justify-center p-4">
    ...
    <hr className="border-t border-gray-600 my-10" />
                ...
                <div className="  flex   text-white text-center">
                  <div className="mt-30 mb-40 border-1 border-white rounded-lg p-4 max-w-4xl">
                    <div className="grid grid-cols-3 divide-x">
                      ...
                      <div className="px-5 py-2">
                        <p className="text-5xl font-bold">Excellent </p>
                        <p className="text-lg mt-2">FreeLancer Rating</p>
                      </div>
                      <div className="px-4 py-2 flex flex-col justify-center">
                        <a
                          ...
                          className="mx-auto border border-purple-800 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-purple-800 hover:border-purple-800 transition"
                        >
                          Download CV
                        </a>
                      </div>
           ...
           <AboutSection />
                ...
                {/* Snap Section 4 */}
    <div className=" h-screen flex   p-4 text-white text-center">
      <div className="max-w-4xl w-full mt-40">
        {/* Title */}
        <h2 className="text-3xl font-bold tracking-wide mb-8 text-left">MY JOURNEY</h2>
    ...
    <section className=" py-24 px-6 text-white text-left">
      <h2 className="mt-40 text-4xl font-bold mb-12 ">SKILLS</h2>
      <hr className="border-t border-gray-600 my-6" />
